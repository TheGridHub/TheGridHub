  ...
  return (
    <nav className="flex flex-col w-[250px] h-full lg:h-screen bg-[#f9f9f9] border-r border-[#e4e4e4] translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:0ms] overflow-y-auto">
            ...
            {mainNavItems.map((item, index) => {
              ...
              return (
                ...
                >
                  <Button
                    variant="ghost"
                    className={`flex h-9 flex-1 items-center justify-start p-2 rounded hover:bg-[#e4e4e4] transition-colors ${
                      isActive ? "bg-[#f1f1f1]" : ""
      ...
      <div className="flex flex-col items-start gap-3 px-4 py-5 w-full border-t border-[#e4e4e4] translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:1400ms] mt-auto">
        ...
        {/* Upgrade Button */}
        <Button className="w-full bg-black text-white hover:bg-black/90 h-auto py-2">
          <span className="font-body-base-medium font-[number:var(--body-base-medium-font-weight)] text-[length:var(--body-base-medium-font-size)] tracking-[var(--body-base-medium-letter-spacing)] leading-[var(--body-base-medium-line-height)] [font-style:var(--body-base-medium-font-style)]">
            Upgrade to Pro
          </span>
        </Button>
      </div>
