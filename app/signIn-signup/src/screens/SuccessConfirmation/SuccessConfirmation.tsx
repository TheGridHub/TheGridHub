...
className="flex flex-col min-h-screen items-center justify-center gap-[21px] p-6 relative bg-white"
    ...
    >
      <div className="flex justify-center w-full">
        <div className="flex-col min-w-80 max-w-[520px] gap-6 pt-[var(--collection-spacing-xl)] pr-[var(--collection-spacing-xxl)] pb-[var(--collection-spacing-xl)] pl-[var(--collection-spacing-xxl)] rounded-2xl border border-gray-200 bg-white shadow-sm flex items-center relative w-full">
