-- Fixed Dashboard Migration - Uses Actual Schema
-- This addresses the email column issue and creates working dashboard objects
...
SELECT 
    ...
    -- Usage counts with error handling
