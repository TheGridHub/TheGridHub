-- Create Missing Tables Migration (2025-01-21)
-- This creates only the tables that don't exist and are needed for the dashboard

-- =====================================================
-- CREATE MISSING TABLES (only if they don't exist)
-- =====================================================

-- Companies table (needed for dashboard)
...
-- Notes table (needed for dashboard)
...
-- Emails table (needed for dashboard)
...
-- Notifications table (needed for dashboard)
...
-- Calendar Events table (needed for dashboard)
...
-- Teams table (needed for dashboard)
...
-- AI Requests table (needed for dashboard)
