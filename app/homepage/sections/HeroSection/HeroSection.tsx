    ...
    <section className="flex items-center gap-8 pl-20 pr-0 py-0 relative self-stretch w-full flex-[0_0_auto] z-[7] bg-white shadow-[0px_4px_200px_#e8f9f733]">
      ...
      <div className="flex flex-col w-[624px] items-start gap-9 relative">
        <div className="flex flex-col items-start gap-4 relative self-stretch w-full flex-[0_0_auto]">
          ...
          <p className="relative self-stretch font-heading-desktop-h6 font-[number:var(--heading-desktop-h6-font-weight)] text-[#717171] text-[length:var(--heading-desktop-h6-font-size)] tracking-[var(--heading-desktop-h6-letter-spacing)] leading-[var(--heading-desktop-h6-line-height)] [font-style:var(--heading-desktop-h6-font-style)] translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms]">
            Streamline Operations, Boost Efficiency, and Drive Growth
          </p>

          <div className="flex items-center gap-8 relative self-stretch w-full flex-[0_0_auto] translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:300ms]">
            <div className="flex items-center gap-2">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20 6L9 17L4 12" stroke="#10B981" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              <span className="font-body-base-regular font-[number:var(--body-base-regular-font-weight)] text-[#717171] text-[length:var(--body-base-regular-font-size)] tracking-[var(--body-base-regular-letter-spacing)] leading-[var(--body-base-regular-line-height)] [font-style:var(--body-base-regular-font-style)]">
                No credit card
              </span>
            </div>
