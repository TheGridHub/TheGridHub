    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <form onSubmit={createProject} className="grid md:grid-cols-4 gap-3 bg-white p-4 rounded-xl shadow-sm border border-gray-200 mb-6">
          <input className="px-3 py-2 rounded-lg bg-white border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200" placeholder="Project name" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} required />
          <input className="px-3 py-2 rounded-lg bg-white border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 md:col-span-2" placeholder="Description" value={form.description} onChange={(e) => setForm({ ...form, description: e.target.value })} />
